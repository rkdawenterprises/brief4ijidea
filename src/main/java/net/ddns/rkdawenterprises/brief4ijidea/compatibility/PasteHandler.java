// intellij-community/platform/lang-impl/src/com/intellij/codeInsight/editorActions/PasteHandler.java
...
//  private static final ExtensionPointName<PasteProvider> EP_NAME = ExtensionPointName.create("com.intellij.customPasteProvider");
    ...
    @Override
    public void doExecute( final @NotNull Editor editor,
                           Caret caret,
                         ...
                         @Nullable Producer<? extends Transferable> producer )
    {
        ...
        DataContext context = CustomizedDataContext.withSnapshot( dataContext,
                                                                  sink ->
                                                                  {
                                                                      sink.set( PasteAction.TRANSFERABLE_PROVIDER,
                                                                                (Producer<Transferable>) ( () -> transferable ) );
                                                                  } );
        ...
        if( file == null || editor.isColumnMode() || editor.getCaretModel().getCaretCount() > 1 )
        {
            ...
            {
                myOriginalHandler.execute( editor,
                                           null,
                                           context );
            }
            return;
...
//        }
    ...
    {
        final TypingActionsExtension typingActionsExtension = TypingActionsExtension.findForContext( project,
                                                                                                     editor );
        try
        {
